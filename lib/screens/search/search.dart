...
class _SearchScreenState extends State<SearchScreen> {
  ...
  Widget _getTopBanner(BuildContext context) {
    return Container(
  ...
  Widget _getBottomBanner(BuildContext context) {
    return Container(
      height: 149,
